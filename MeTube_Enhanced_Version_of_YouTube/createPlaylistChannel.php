...
$urlOne = "createPlaylistChannel.php?flag=" . $flag;
...
<form style = "position: absolute; top: 165px; left: 510px;"
	  method = "post" action = "<?php echo $urlOne; ?>">
...
<?php
if($flag == 0) { ?>
  <button type = "button" class = "fancy_button" style = "position: absolute; top: 220px; left: -32px;"
        onclick = "window.location.href = 'uploadMedia.php'"><span> Uploads </span></button>
<?php
}
else { ?>
