...
$urlOne = "createPlaylistChannel.php?flag=" . 0;
?>
<!DOCTYPE html>
<html>
<head>
...
<img src = "images/board.png" height = "775" width = "650" style = "position: absolute; top: -40px; left: 330px;">
...
<b style = "color: white; font-size: large;">Add To Playlist: </b>
...
<a href = "<?php echo $urlOne; ?>" style = "color: white; font-size: large;">Create</a>
<br/><br/>
<b style = "color: white; font-size: large;">Add To Channel: </b>
<select name = "channel">
  <option value = ""></option>
  <?php
...
<button type = "button" class = "fancy_button" style = "position: absolute; top: 445px; left: -8px;"
...
<button class = "fancy_button" name = "upload" type = "submit" value = "Upload"
          style = "position: absolute; left: 157px; top: 445px;">
